...
if [[ $confirm == [yY] || $confirm == [yY][eE][sS] ]]; then
  ...
  # wine pyinstaller --onefile src/armangrewal007/cli.py --name armangrewal007 
  # wine nuitka --standalone --onefile --output-filename="armangrewal007-0.1.3" src/armangrewal007/cli.py 
